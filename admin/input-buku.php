                    ...
                    <div class="row">
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-buku.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="id_buku" type="text" id="id_buku" class="form-control" placeholder="Tidak perlu di isi" autofocus="on" readonly="readonly" />
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="pengarang" type="text" id="pengarang" class="form-control" placeholder="Pengarang" required />
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="kode_klas" type="text" id="kode_klas" class="form-control" placeholder="Kode Kelas" required />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Jumlah Buku</label>
                              <div class="col-sm-8">
                                  <input name="jumlah_buku" type="text" id="jumlah_buku" class="form-control" placeholder="Jumlah Buku" required />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Lokasi</label>
                              <div class="col-sm-8">
                                  <input name="lokasi" type="text" id="lokasi" class="form-control" placeholder="Lokasi" required />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Asal</label>
                              <div class="col-sm-8">
                                  <input name="asal" type="text" id="asal" class="form-control" placeholder="Asal" required />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Jumlah Temp</label>
                              <div class="col-sm-8">
                                  <input name="jum_temp" type="text" id="jum_temp" class="form-control" placeholder="Jumlah Temp" required />
                              </div>
                          </div>
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <div class="input-group date " data-date="" data-date-format="yyyy-mm-dd">
                                    <input class="form-control" type="text" name="tgl_input" id="tgl_input" placeholder="Tanggal Input" readonly="readonly">
                          ...
                          <div class="form-group" style="margin-bottom: 20px;">
                              ...
                              <div class="col-sm-8">
	                              ...
	                              <a href="input-buku.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
