...
<?php } ?>
                ...
                <section class="content">
                    ...
                    <div class="row" style="margin-bottom:5px;">
                        ...
                        <div class="col-md-3">
                            <div class="sm-st clearfix">
                                ...
                                <?php $tampil=$conn->query("select * from data_anggota order by id_anggota desc");
                    ...
                    ?>
                        ...
                        <div class="col-md-3">
                            <div class="sm-st clearfix">
                                ...
                                <div class="sm-st-info">
                                <?php $tampil=$conn->query("select * from data_buku order by id_buku desc");
                    ...
                    ?>
                        ...
                        <div class="col-md-3">
                            <div class="sm-st clearfix">
                                ...
                                <div class="sm-st-info">
                                <?php $tampil=$conn->query("select * from trans_pinjam order by id_pinjam desc");
                    ...
                    ?>
                        ...
                        <div class="col-md-3">
                            <div class="sm-st clearfix">
                                ...
                                <div class="sm-st-info">
                                <?php $tampil=$conn->query("select * from pengunjung order by id_pengunjung desc");
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <section class="panel">
                                            <header class="panel-heading">
                                                ...
                                                <?php
                                                $tampil=$conn->query("select * from data_anggota order by id_anggota desc limit 1");
                                                ...
                                                <?php
                                                $tampil=$conn->query("select * from admin order by user_id desc limit 1");
                                                ...
                                                <?php
                                                $tampil=$conn->query("select * from data_buku order by id_buku desc limit 1");
                                                ...
                                                <?php
                                                $tampil=$conn->query("select * from pengunjung order by id_pengunjung desc limit 1");
                    ...
                    <div class="row">
                        ...
                        $tampil=$conn->query("select * from data_anggota order by id_anggota desc limit 3");
                          ...
                          <section class="panel tasks-widget">
                            ...
                            <div class="panel-body">
                              ...
                              <div class="task-content">
                                  ...
                                  <ul class="task-list">
                                  <?php
                                  $tampil=$conn->query("select * from data_buku order by id_buku desc limit 5");
